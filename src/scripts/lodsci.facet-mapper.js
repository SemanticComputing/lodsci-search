(function() {
    ...
    */
    ...
    .factory('tagStrippingFacetMapper', tagStrippingFacetMapper);

    /* ngInject */
    function tagStrippingFacetMapper(_, facetMapperService) {
        ...
        function makeObject(obj) {
            ...
            o.text = _.get(obj, 'facet_text.value').replace(/<.*?>/g, '');
